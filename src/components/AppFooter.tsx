  ...
  const footerNav = [
    {
      ...
      links: [
        { href: '/cases', label: t.footer.caseList },
        { href: '/stories', label: t.footer.storyList },
        { href: '/learn', label: t.footer.learnList },
      ],
    },
    {
      heading: t.footer.archive,
      links: [
        { href: '/timeline', label: t.footer.timelineList },
        { href: '/gallery', label: t.footer.galleryList },
        { href: '/about', label: t.footer.aboutList },
      ],
    },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-12">
          ...
          <div className="md:col-span-5">
            <Link href="/" className="inline-flex items-center gap-3 group mb-5">
              ...
              >
                <Archive size={19} style={{ color: 'var(--color-gold)' }} />
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span>{t.footer.originalSite}</span>
              </a>
            </div>
          </div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a
                    ...
                    style={{ color: 'var(--color-text-secondary)' }}
                  >
                    <span>{t.footer.sourceSupport}</span>
                    <ExternalLink size={11} />
                  </a>
                </li>
              </ul>
